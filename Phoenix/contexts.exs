...
# User 1 loads the product page with count of 13
# User 1 saves the product page with count of 14
# User 2 loads the product page with count of 14
# User 2 saves the product page with count of 15
# While in practice this would happen:

# User 1 loads the product page with count of 13
# User 2 loads the product page with count of 13
# User 1 saves the product page with count of 14
# User 2 saves the product page with count of 14
...
# Add products to a user's cart from the product show page
# Store point-in-time product price information at time of carting
# Store and update quantities in cart
# Calculate and display sum of cart prices
